...
describe('API Manager', () => {
  ...
  describe('generateAIImage', () => {
    test('successfully generates image with valid API key', async () => {
      ...
      const result = await apiManager.generateAIImage('test-prompt', 'test-api-key');
    ...
    test('handles API error gracefully', async () => {
      ...
      const result = await apiManager.generateAIImage('test-prompt', 'invalid-key');
    ...
    test('handles network error', async () => {
      ...
      const result = await apiManager.generateAIImage('test-prompt', 'test-key');
